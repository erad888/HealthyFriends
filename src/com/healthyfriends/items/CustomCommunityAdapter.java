...
public class CustomCommunityAdapter extends ArrayAdapter<CommunityItem> {
	Context context;
    int layoutResourceId;
    LinearLayout linearMain;
    ArrayList<CommunityItem> data = new ArrayList<CommunityItem>();

    public CustomCommunityAdapter(Context context, int layoutResourceId,
                  ArrayList<CommunityItem> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       CommunityItem myItem = data.get(position);
       ...
       TextView authorLabel = (TextView) row.findViewById(R.id.nameText);
       authorLabel.setText(myItem.details[0]);
       TextView checkoutIndividual = (TextView) row.findViewById(R.id.pointsValue);
